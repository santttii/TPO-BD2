...
class EnrollmentService:
    ...
    def enroll(self, person_id: str, course_id: str) -> Dict[str, Any]:
            ...
            if not self.people.find_one(person_id):
            ...
            try:
                ...
                self.graph.upsert_inscripcion(person_id, course_id, progreso=0, estado="No empezó")
    ...
    def update_progress(self, enr_id: str, progreso: int, nota: Optional[int] = None) -> Dict[str, Any]:
            ...
            try:
                self.graph.set_inscripcion_progreso(doc["personId"], doc["courseId"], progreso)
            except Exception as e:
